...
// Funzione per aggiornare la scala in base alla larghezza finestra
function updateScale() {
  if (window.innerWidth <= 768) {
    earthDay.scale.set(1, 1, 1);
    earthNight.scale.set(1.01, 1.01, 1.01);
    clouds.scale.set(1.02, 1.02, 1.02);
  } else {
...
// Esegui aggiornamento scala iniziale
updateScale();
...
// Aggiorna scala al resize finestra
